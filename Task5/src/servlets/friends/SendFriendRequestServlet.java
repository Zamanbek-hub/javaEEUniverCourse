...
@WebServlet(value="/send_friend_request")
public class SendFriendRequestServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if(DBManager.sendFriendRequest(friend_id, current_user.getId())){
                response.sendRedirect("/friends?success=true&type=1&search_user="+search_user);
